...
namespace HousingManager.Data.Library.Models
{
    ...
    public HousingManagerDBContext(DbContextOptions<HousingManagerDBContext> options)
    : base(options)
    { }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ApartmentSupplyRequest>(entity =>
            {
                entity.HasKey(e => e.SupplyRequestId)
                    .HasName("PK__Apartmen__63400C5E369831C1");
            ...
            modelBuilder.Entity<ApartmentUnit>(entity =>
            {
                ...
                entity.HasIndex(e => e.AddressId)
                    .HasName("UQ__Apartmen__091C2AFAA251D005")
                    .IsUnique();
            ...
            modelBuilder.Entity<HouseKeeping>(entity =>
            {
                ...
                entity.HasIndex(e => e.ApartmentUnitId)
                    .HasName("UQ__HouseKee__446DA74179A576ED")
                    .IsUnique();
            ...
            {
                entity.HasKey(e => e.SupplyRequestId)
                    .HasName("PK__Provider__63400C5E5BACCD58");
            ...
            modelBuilder.Entity<TenantInfo>(entity =>
            {
                entity.HasKey(e => e.TenantInfo1)
                    .HasName("PK__TenantIn__5496378A5AECF985");

                entity.ToTable("TenantInfo", "Person");

                entity.HasIndex(e => e.PersonId)
                    .HasName("UQ__TenantIn__AA2FFBE44210087A")
                    .IsUnique();
